    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-r from-red-600 to-red-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">이용약관</h1>
                ...
                <ol className="list-decimal list-inside space-y-3">
                  ...
                  <li>환불 규정:
                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                      ...
                      <li>대회 접수 마감 후: 환불 불가 (정원 초과로 조기 마감된 경우 포함)</li>
                    </ul>
                  </li>
                  <li>회사의 사정으로 대회가 취소되는 경우 참가비 전액을 환불합니다. 단, 천재지변, 자연재해, 기상악화, 감염병 등 불가항력적 사유로 인한 취소의 경우 환불이 제한될 수 있으며, 이 경우 별도 공지를 통해 안내합니다.</li>
                </ol>
              </div>
